...
pub use backend::prepared_witness_feed::{
    ...
    WitnessFeedRowDomain, WitnessFeedSourceRead, WitnessFeedWorkspaceRequirements,
    WitnessFeedWorkspaceSlots, WITNESS_FEED_DESCRIPTOR_FIELD_ORDER, WITNESS_FEED_DESCRIPTOR_WORDS,
