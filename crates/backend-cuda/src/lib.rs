...
pub use backend::prepared_progressive_commit::{
    ...
    DomainCooperativeStep, FusedCompactDomainOperation, FusedCompactDomainProgram,
    FusedCompactDomainProgramError, FusedCompactDomainReceipt, FusedCompactDomainStep,
    FusedCompactDomainTransition, ModeAwareCommitWorkspaceRequirements,
    ...
    PreparedDirectRetainedB2nGraph, PreparedPrecomputedCompactDomainCommitGraph,
    ...
    ShapeWideLeafOperation, ShapeWideLeafStep, ShapeWideSlabLayout, COMPOSITION_RETAINED_COLUMNS,
    COMPOSITION_SOURCE_COORDINATES,
};
