...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_23630e2413ed4300(
    ...
    b3 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    b6 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    b23 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    b10 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    ...
    StwoCudaQm31 e8 = stwo_load_qm31(ext_params, 0u);
