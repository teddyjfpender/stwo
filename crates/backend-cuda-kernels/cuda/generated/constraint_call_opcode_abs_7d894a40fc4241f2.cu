...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_aaec7bbec10eedef(
    ...
    b23 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    unsigned b39 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    unsigned b40 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    unsigned b41 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    unsigned b42 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, 0);
    unsigned b43 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, 0);
    unsigned b44 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, 0);
    unsigned b45 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 7u, row_index, 0);
    unsigned b46 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, 0);
    unsigned b47 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, 0);
    unsigned b48 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, 0);
    unsigned b49 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, 0);
    unsigned b50 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 12u, row_index, 0);
    unsigned b51 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 13u, row_index, 0);
    unsigned b52 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 14u, row_index, 0);
    unsigned b53 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 15u, row_index, 0);
    unsigned b54 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 16u, row_index, -1);
    unsigned b55 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 16u, row_index, 0);
    unsigned b56 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 17u, row_index, -1);
    unsigned b57 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 17u, row_index, 0);
    unsigned b58 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 18u, row_index, -1);
    unsigned b59 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 18u, row_index, 0);
    unsigned b60 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 19u, row_index, -1);
    unsigned b61 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 19u, row_index, 0);
