...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_bc762e9e3f2cfaf7(
    ...
    b50 = 8u;
    unsigned b53 = stwo_m31_add(b50, b52);
    b50 = 32768u;
    b52 = stwo_m31_sub(b3, b50);
    b50 = stwo_m31_mul(b4, b2);
    unsigned b54 = 1u;
    unsigned b55 = stwo_m31_sub(b54, b4);
    b54 = stwo_m31_mul(b55, b1);
    b55 = stwo_m31_add(b50, b54);
    b54 = stwo_m31_sub(b6, b55);
    b55 = stwo_m31_add(b6, b52);
    ...
    b52 = 256u;
    unsigned b56 = stwo_m31_sub(b35, b52);
    b52 = stwo_m31_mul(b50, b50);
    b50 = stwo_m31_mul(b4, b4);
    b4 = stwo_m31_add(b52, b50);
    b50 = stwo_m31_mul(b56, b56);
    b56 = stwo_m31_add(b4, b50);
    b50 = stwo_m31_add(b6, b56);
    b56 = stwo_m31_mul(b50, b37);
    b50 = 1u;
    b37 = stwo_m31_sub(b56, b50);
    b50 = 1u;
    b56 = stwo_m31_add(b0, b50);
    b50 = 1u;
    ...
    b52 = 511u;
    unsigned b58 = stwo_m31_mul(b40, b52);
    b52 = 136u;
    unsigned b59 = stwo_m31_mul(b39, b52);
    b52 = stwo_m31_sub(b59, b40);
    b59 = 256u;
    unsigned b60 = stwo_m31_mul(b39, b59);
    b59 = 1u;
    unsigned b61 = stwo_m31_sub(b59, b45);
    b59 = stwo_m31_mul(b45, b61);
    b61 = 1u;
    unsigned b62 = stwo_m31_mul(b59, b61);
    b61 = 2u;
    b59 = stwo_m31_mul(b45, b61);
    b61 = stwo_m31_sub(b44, b59);
    b59 = 1u;
    b45 = stwo_m31_sub(b59, b61);
    b59 = stwo_m31_mul(b61, b45);
    b45 = 1u;
    b61 = stwo_m31_mul(b59, b45);
    b45 = stwo_m31_add(b44, b57);
    b57 = 512u;
    b59 = stwo_m31_mul(b42, b57);
    b57 = stwo_m31_add(b41, b59);
    b59 = 262144u;
    unsigned b63 = stwo_m31_mul(b43, b59);
    b59 = stwo_m31_add(b57, b63);
    b63 = 134217728u;
    b57 = stwo_m31_mul(b44, b63);
    b63 = stwo_m31_add(b59, b57);
    b57 = stwo_m31_sub(b63, b39);
    b63 = 536870912u;
    b39 = stwo_m31_mul(b63, b40);
    b63 = stwo_m31_sub(b57, b39);
    b39 = stwo_m31_mul(b46, b46);
    b57 = stwo_m31_sub(b39, b46);
    b39 = stwo_m31_add(b0, b63);
    b63 = stwo_m31_add(b1, b5);
    b5 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    b40 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    b59 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    b44 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    unsigned b64 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, 0);
    unsigned b65 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, 0);
    unsigned b66 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, 0);
    unsigned b67 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 7u, row_index, 0);
    unsigned b68 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, 0);
    unsigned b69 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, 0);
    unsigned b70 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, 0);
    unsigned b71 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, 0);
    unsigned b72 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 12u, row_index, -1);
    unsigned b73 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 12u, row_index, 0);
    unsigned b74 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 13u, row_index, -1);
    unsigned b75 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 13u, row_index, 0);
    unsigned b76 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 14u, row_index, -1);
    unsigned b77 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 14u, row_index, 0);
    unsigned b78 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 15u, row_index, -1);
    unsigned b79 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 15u, row_index, 0);

    // Ext instructions.
    StwoCudaQm31 e0 = StwoCudaQm31{ b47, b48, b48, b48 };
    StwoCudaQm31 e1 = StwoCudaQm31{ b49, b48, b48, b48 };
    StwoCudaQm31 e2 = stwo_load_qm31(ext_params, 0u);
    StwoCudaQm31 e3 = StwoCudaQm31{ b0, b48, b48, b48 };
    StwoCudaQm31 e4 = stwo_qm31_mul(e2, e3);
    e3 = stwo_load_qm31(ext_params, 1u);
    e2 = stwo_qm31_add(e3, e4);
    e3 = stwo_load_qm31(ext_params, 2u);
    e4 = StwoCudaQm31{ b3, b48, b48, b48 };
    ...
    e3 = StwoCudaQm31{ b22, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    e8 = stwo_load_qm31(ext_params, 22u);
    e7 = StwoCudaQm31{ b23, b48, b48, b48 };
    e6 = stwo_qm31_mul(e8, e7);
    e7 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(ext_params, 23u);
    e3 = StwoCudaQm31{ b24, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    e8 = stwo_load_qm31(ext_params, 24u);
    e7 = StwoCudaQm31{ b25, b48, b48, b48 };
    e6 = stwo_qm31_mul(e8, e7);
    e7 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(ext_params, 25u);
    e3 = StwoCudaQm31{ b26, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    e8 = stwo_load_qm31(ext_params, 26u);
    e7 = StwoCudaQm31{ b27, b48, b48, b48 };
    e6 = stwo_qm31_mul(e8, e7);
    e7 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(ext_params, 27u);
    e3 = StwoCudaQm31{ b28, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    ...
    e3 = StwoCudaQm31{ b30, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    e8 = stwo_load_qm31(ext_params, 30u);
    e7 = StwoCudaQm31{ b31, b48, b48, b48 };
    e6 = stwo_qm31_mul(e8, e7);
    e7 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(ext_params, 31u);
    e3 = StwoCudaQm31{ b32, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    e8 = stwo_load_qm31(ext_params, 32u);
    e7 = StwoCudaQm31{ b33, b48, b48, b48 };
    e6 = stwo_qm31_mul(e8, e7);
    e7 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(ext_params, 33u);
    e3 = StwoCudaQm31{ b34, b48, b48, b48 };
    e8 = stwo_qm31_mul(e6, e3);
    e3 = stwo_qm31_add(e7, e8);
    e8 = stwo_load_qm31(ext_params, 34u);
    e7 = StwoCudaQm31{ b35, b48, b48, b48 };
    e6 = stwo_qm31_mul(e8, e7);
    e7 = stwo_qm31_add(e3, e6);
    e6 = stwo_load_qm31(ext_params, 7u);
    e3 = stwo_qm31_sub(e7, e6);
    e6 = StwoCudaQm31{ b36, b48, b48, b48 };
    e7 = StwoCudaQm31{ b37, b48, b48, b48 };
    e8 = stwo_load_qm31(ext_params, 0u);
    StwoCudaQm31 e9 = StwoCudaQm31{ b56, b48, b48, b48 };
    ...
    e10 = StwoCudaQm31{ b38, b48, b48, b48 };
    StwoCudaQm31 e11 = stwo_qm31_mul(e9, e10);
    e10 = stwo_qm31_add(e8, e11);
    e11 = stwo_load_qm31(ext_params, 7u);
    e8 = stwo_qm31_sub(e10, e11);
    e11 = StwoCudaQm31{ b50, b48, b48, b48 };
    e10 = StwoCudaQm31{ b6, b48, b48, b48 };
    e9 = StwoCudaQm31{ b4, b48, b48, b48 };
    StwoCudaQm31 e12 = StwoCudaQm31{ b62, b48, b48, b48 };
    StwoCudaQm31 e13 = StwoCudaQm31{ b61, b48, b48, b48 };
    StwoCudaQm31 e14 = stwo_load_qm31(ext_params, 0u);
    StwoCudaQm31 e15 = StwoCudaQm31{ b38, b48, b48, b48 };
    ...
    e14 = StwoCudaQm31{ b52, b48, b48, b48 };
    e15 = stwo_qm31_mul(e17, e14);
    e14 = stwo_qm31_add(e16, e15);
    ...
    e16 = StwoCudaQm31{ b72, b74, b76, b78 };
    e8 = StwoCudaQm31{ b73, b75, b77, b79 };
