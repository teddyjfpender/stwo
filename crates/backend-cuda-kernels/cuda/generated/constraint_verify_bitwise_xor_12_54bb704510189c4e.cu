...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_f1fce1a97a4f75dc(
    ...
    b6 = stwo_trace_value(trace_cols, interaction_offsets, row_count, log_n_rows, 1u, 1u, row_index, 0);
    unsigned b9 = 0u;
