...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_ad13f4b2c221bfc7(
    ...
    unsigned b4 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 1u, 1u, row_index, 0);
    unsigned b5 = 0u;
    unsigned b6 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, -1);
    unsigned b7 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    unsigned b8 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, -1);
    unsigned b9 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    unsigned b10 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, -1);
    unsigned b11 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    unsigned b12 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, -1);
