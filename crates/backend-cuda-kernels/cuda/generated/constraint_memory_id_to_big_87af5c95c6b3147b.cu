...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_cb1ce2703d2db392(
    ...
    b31 = stwo_trace_value(trace_cols, interaction_offsets, row_count, log_n_rows, 2u, 0u, row_index, 0);
    b32 = stwo_trace_value(trace_cols, interaction_offsets, row_count, log_n_rows, 2u, 1u, row_index, 0);
