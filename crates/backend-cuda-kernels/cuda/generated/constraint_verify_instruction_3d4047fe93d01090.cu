...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_598b3f5cd7a508ff(
    ...
    unsigned b24 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    unsigned b25 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    unsigned b26 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    unsigned b27 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    unsigned b28 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, 0);
    unsigned b29 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, 0);
    unsigned b30 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, 0);
    unsigned b31 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 7u, row_index, 0);
    unsigned b32 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, -1);
    unsigned b33 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, 0);
    unsigned b34 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, -1);
    unsigned b35 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, 0);
    unsigned b36 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, -1);
    unsigned b37 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, 0);
    unsigned b38 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, -1);
    unsigned b39 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, 0);

    // Ext instructions.
    StwoCudaQm31 e0 = StwoCudaQm31{ b18, b17, b17, b17 };
    StwoCudaQm31 e1 = StwoCudaQm31{ b21, b17, b17, b17 };
    StwoCudaQm31 e2 = StwoCudaQm31{ b22, b17, b17, b17 };
    StwoCudaQm31 e3 = stwo_load_qm31(ext_params, 0u);
    StwoCudaQm31 e4 = StwoCudaQm31{ b8, b17, b17, b17 };
    StwoCudaQm31 e5 = stwo_qm31_mul(e3, e4);
    e4 = stwo_load_qm31(ext_params, 1u);
    e3 = stwo_qm31_add(e4, e5);
    e4 = stwo_load_qm31(ext_params, 2u);
    e5 = StwoCudaQm31{ b9, b17, b17, b17 };
    ...
    e10 = StwoCudaQm31{ b1, b17, b17, b17 };
    ...
    e10 = StwoCudaQm31{ b3, b17, b17, b17 };
    e11 = stwo_qm31_mul(e9, e10);
    e10 = stwo_qm31_add(e3, e11);
    e11 = stwo_load_qm31(ext_params, 9u);
    e3 = StwoCudaQm31{ b4, b17, b17, b17 };
    e9 = stwo_qm31_mul(e11, e3);
    e3 = stwo_qm31_add(e10, e9);
    e9 = stwo_load_qm31(ext_params, 10u);
    e10 = StwoCudaQm31{ b5, b17, b17, b17 };
    e11 = stwo_qm31_mul(e9, e10);
    e10 = stwo_qm31_add(e3, e11);
    e11 = stwo_load_qm31(ext_params, 11u);
    e3 = StwoCudaQm31{ b6, b17, b17, b17 };
    e9 = stwo_qm31_mul(e11, e3);
    e3 = stwo_qm31_add(e10, e9);
