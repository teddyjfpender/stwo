...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_d5393c25fbb2874d(
    ...
    unsigned b18 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    unsigned b19 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    unsigned b20 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    unsigned b21 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, 0);
    unsigned b22 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, 0);
    unsigned b23 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, 0);
    unsigned b24 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 7u, row_index, 0);
    unsigned b25 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, -1);
    unsigned b26 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, 0);
    unsigned b27 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, -1);
    unsigned b28 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, 0);
    unsigned b29 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, -1);
    unsigned b30 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, 0);
    unsigned b31 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, -1);
    unsigned b32 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, 0);
    ...
    e8 = StwoCudaQm31{ b12, b10, b10, b10 };
    e3 = stwo_load_qm31(ext_params, 0u);
    e6 = StwoCudaQm31{ b0, b10, b10, b10 };
    ...
    e3 = StwoCudaQm31{ b2, b10, b10, b10 };
    ...
    e10 = StwoCudaQm31{ b4, b10, b10, b10 };
    ...
    e9 = StwoCudaQm31{ b5, b18, b19, b20 };
    ...
    e9 = StwoCudaQm31{ b25, b27, b29, b31 };
    e4 = StwoCudaQm31{ b26, b28, b30, b32 };
