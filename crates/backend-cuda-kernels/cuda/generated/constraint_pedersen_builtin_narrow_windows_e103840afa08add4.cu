...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_32253639c9d1b2c6(
    ...
    unsigned b8 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    unsigned b9 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    unsigned b10 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    unsigned b11 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, -1);
    unsigned b12 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, 0);
    unsigned b13 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, -1);
    unsigned b14 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, 0);
    unsigned b15 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, -1);
    unsigned b16 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, 0);
    unsigned b17 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 7u, row_index, -1);
    ...
    e1 = StwoCudaQm31{ b7, b4, b4, b4 };
    e2 = stwo_qm31_mul(e4, e1);
    e1 = stwo_load_qm31(ext_params, 1u);
    e4 = stwo_qm31_add(e1, e2);
    e1 = stwo_load_qm31(ext_params, 2u);
    e2 = StwoCudaQm31{ b3, b4, b4, b4 };
    ...
    e1 = StwoCudaQm31{ b5, b8, b9, b10 };
    e4 = stwo_qm31_mul(e1, e6);
    e6 = stwo_qm31_sub(e4, e2);
    e4 = StwoCudaQm31{ b11, b13, b15, b17 };
    e2 = StwoCudaQm31{ b12, b14, b16, b18 };
