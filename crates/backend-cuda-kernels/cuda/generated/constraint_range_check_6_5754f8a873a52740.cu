...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_b455671faf7e7149(
    ...
    unsigned b2 = 0u;
    unsigned b3 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, -1);
    unsigned b4 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    unsigned b5 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, -1);
    unsigned b6 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    unsigned b7 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, -1);
    unsigned b8 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    unsigned b9 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, -1);
