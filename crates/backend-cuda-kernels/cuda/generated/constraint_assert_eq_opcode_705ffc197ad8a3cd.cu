...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_3f818d142612918f(
    ...
    b7 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    b23 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    b19 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 2u, row_index, 0);
    b5 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 3u, row_index, 0);
    unsigned b24 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 4u, row_index, 0);
    unsigned b25 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 5u, row_index, 0);
    unsigned b26 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 6u, row_index, 0);
    unsigned b27 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 7u, row_index, 0);
    unsigned b28 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, -1);
    unsigned b29 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 8u, row_index, 0);
    unsigned b30 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, -1);
    unsigned b31 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 9u, row_index, 0);
    unsigned b32 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, -1);
    unsigned b33 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 10u, row_index, 0);
    unsigned b34 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, -1);
    unsigned b35 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 11u, row_index, 0);

    // Ext instructions.
    StwoCudaQm31 e0 = StwoCudaQm31{ b12, b13, b13, b13 };
    StwoCudaQm31 e1 = StwoCudaQm31{ b14, b13, b13, b13 };
    StwoCudaQm31 e2 = StwoCudaQm31{ b15, b13, b13, b13 };
    StwoCudaQm31 e3 = stwo_load_qm31(ext_params, 0u);
    StwoCudaQm31 e4 = StwoCudaQm31{ b0, b13, b13, b13 };
    StwoCudaQm31 e5 = stwo_qm31_mul(e3, e4);
    e4 = stwo_load_qm31(ext_params, 1u);
    e3 = stwo_qm31_add(e4, e5);
    e4 = stwo_load_qm31(ext_params, 2u);
    e5 = StwoCudaQm31{ b3, b13, b13, b13 };
