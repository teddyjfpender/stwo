...
extern "C" __global__ void __launch_bounds__(128) stwo_jit_fused_d0a2396eb5e8e845(
    ...
    b31 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 0u, row_index, 0);
    b32 = stwo_trace_value(trace_cols, interaction_offsets, row_count, 2u, 1u, row_index, 0);
    ...
    e2 = StwoCudaQm31{ b0, b30, b30, b30 };
    ...
    e18 = stwo_load_qm31(ext_params, 12u);
    ...
    e2 = stwo_qm31_mul(e18, e16);
    e16 = stwo_qm31_add(e17, e2);
    e2 = stwo_load_qm31(ext_params, 15u);
    ...
    e2 = stwo_qm31_mul(e18, e16);
    e16 = stwo_qm31_add(e17, e2);
    e2 = stwo_load_qm31(ext_params, 31u);
    ...
    e2 = stwo_qm31_mul(e18, e16);
    e16 = stwo_qm31_add(e17, e2);
    e2 = stwo_load_qm31(ext_params, 33u);
    ...
    e2 = stwo_load_qm31(ext_params, 39u);
    ...
    e15 = StwoCudaQm31{ b31, b32, b33, b34 };
    e14 = stwo_qm31_mul(e15, e18);
    e18 = stwo_qm31_sub(e14, e2);
    e14 = StwoCudaQm31{ b35, b36, b37, b38 };
